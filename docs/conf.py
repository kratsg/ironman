...
release = pkg_resources.get_distribution('ironman').version
...
latex_documents = [
    (master_doc, 'ironman.tex', 'ironman Documentation', 'Giordon Stark', 'manual'),
]
...
man_pages = [(master_doc, 'ironman', 'ironman Documentation', [author], 1)]
